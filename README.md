...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    -Semantic HTML is the markup language that is used to clearly define the contents on a webpage. It's the code that tells you where everythng is located on the page. 
...
3. While using flexbox, what axis does the following property work on: ```align-items: center```?
    ...
    -It controls the alignment of all the flex items on the cross axis. 

4. Explain why git is valuable to a team of developers.

    -Git helps web developers moniter the changes of the code during the development of the code across multiple people. 

5. Define mobile-first design in your own words.

    -Mobile-first design is creating a website with the dimensions of a smaller screen first and working your way up to a bigger screen with bigger dimensions. 
